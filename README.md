...
- Mac M系列芯片的客户端版本，下载后会提示已损坏，原因是没有签名，可以通过在命令行执行：`sudo xattr -cr /Applications/oFinder.app` 来移除应用上来自网络的“隔离”标记，让系统“认识”它，从而让软件正常运行
- Mac Intel芯片的客户端版本，可以正常使用，但是在M系列芯片上使用该版本的时候，会提示跟软件跟芯片版本的兼容问题，并且后续会逐步不支持在M系列芯片上打开Intel芯片的客户端版本
